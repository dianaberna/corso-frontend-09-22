...
// console.log("-----------------------------------------");
// console.log("--Esercizio 17 - Quanti giorni tra due date--");
...
// //Esercizio  18 - Ottieni la somma del budget delle persone
// console.log("-----------------------------------------");
// console.log("--Esercizio 18 - Ottieni la somma del budget delle persone --");
...
// const eserciziCall = function chiamaEs() {
//   console.log("👋🏻");
// };

// const tit = document.getElementById("titolo");
// document.tit.addEventListener("click", eserciziCall);
