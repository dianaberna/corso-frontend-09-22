...
window.addEventListener("load", function () {
    ...
    // TODO : FIXME ; fix the fill , or edit it, maybe even add the correct SVG if it is the issue I think it is
    let faultySvg = document.querySelector(".song-card svg");
    faultySvg.setAttribute("fill","currentColor");
    faultySvg.cssText = "fill: white; stroke: green;";
    alert(faultySvg.cssText)
});